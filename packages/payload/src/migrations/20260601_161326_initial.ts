...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "_posts_v" ADD CONSTRAINT "_posts_v_version_author_user_id_users_id_fk" FOREIGN KEY ("version_author_user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "_posts_v_version_version_author_user_idx" ON "_posts_v" USING btree ("version_author_user_id");
